...
3. Start coding!
    - Refer to the
      ...
      [CubeWorld Documentation](https://docs.luanti.org/) and other
...
2. Is it an issue with the CubeWorld *engine*? If not, report it
...
3. [Open an issue](https://github.com/luanti-org/luanti/issues/new) and describe
   the issue you are having - you could include:
     ...
     - Your CubeWorld version and the content (games, mods or texture packs) you have installed.
...
The core translations of CubeWorld are performed using Weblate. You can access
...
If you'd like to monetarily support CubeWorld development, you can find donation
methods on [our website](http://www.luanti.org/development/#donate).

# Maintaining

* This is a concise version of the
  [Rules & Guidelines](https://docs.luanti.org/for-engine-devs/) on the CubeWorld Documentation.*

These notes are for those who have push access CubeWorld (core developers / maintainers).
