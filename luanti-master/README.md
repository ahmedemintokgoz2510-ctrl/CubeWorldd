<div align="center">
    ...
    <h1>CubeWorld (formerly Minetest)</h1>
...
CubeWorld is a free open-source voxel game engine with easy modding and game creation.
...
- CubeWorld Documentation: https://docs.luanti.org/
...
- Default location:
    `user/minetest.conf`
- This file is created by closing CubeWorld for the first time.
