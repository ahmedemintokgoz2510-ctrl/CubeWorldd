...
When a security issue is discovered, the CubeWorld team may choose to include the
...
Our primary concerns for the security of CubeWorld are:
...
* the user can configure CubeWorld so that it crashes/stops functioning
