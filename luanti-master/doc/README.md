...
This directory contains mostly reference documentation for the CubeWorld engine.
...
- [texture_packs.md](texture_packs.md): Layout and description of CubeWorld's
...
- [world_format.md](world_format.md): Structure of CubeWorld world directories and
...
- [protocol.txt](protocol.txt): *Rough* outline of CubeWorld's network protocol.
...
- [developing/](developing/): Information about CubeWorld development.
...
- [direction.md](direction.md): Information related to the future direction of
    CubeWorld. Commonly referred to as the roadmap document.
