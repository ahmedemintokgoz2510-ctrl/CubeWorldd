# CubeWorld Android build
All CubeWorld builds, including the Android variant, are based on the same code.
...
## File Path
There are some settings especially useful for Android users. The CubeWorld-wide
...
## Requirements
The recommended system requirements for CubeWorld are listed below.
...
The new build system CubeWorld Android is fully functional and is designed to
