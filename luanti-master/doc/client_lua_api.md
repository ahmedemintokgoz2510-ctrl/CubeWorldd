CubeWorld Lua Client Modding API Reference 5.18.0
==============================================
...
Content and functionality can be added to CubeWorld by using Lua
scripting in run-time loaded mods.

A mod is a self-contained bunch of scripts, textures and other related
things that is loaded by and interfaces with CubeWorld.
