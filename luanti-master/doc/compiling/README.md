...
General options and their default values:
    ...
    BUILD_CLIENT=TRUE          - Build CubeWorld client
    BUILD_SERVER=FALSE         - Build CubeWorld server
    ...
    INSTALL_DEVTEST=FALSE      - Whether the Development Test game should be installed alongside CubeWorld
    ...
    VERSION_EXTRA=             - Text to append to version (e.g. VERSION_EXTRA=foobar -> CubeWorld 5.10.0-foobar)
