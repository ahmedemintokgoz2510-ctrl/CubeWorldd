# CubeWorld Generative AI Policy
...
turn wastes the time of CubeWorld's reviewers. As such, contributions to the
CubeWorld engine may only use generative AI tools as permitted by this policy.
...
- AI may not be used to generate art, music, sounds, or any other media in the
  CubeWorld engine. Many people feel very strongly about how machines should be
...
- Exploring the CubeWorld codebase with "fuzzy" searches or understanding code
