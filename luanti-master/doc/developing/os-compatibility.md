...
libraries, build tools (CMake) or compilers CubeWorld requires.
...
Being able to play CubeWorld on a recent low-end phone is a reasonable target.
...
* Can we make it easier for users to build the library together with CubeWorld?
