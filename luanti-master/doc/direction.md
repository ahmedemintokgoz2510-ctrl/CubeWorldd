...
These are the current medium-term goals for CubeWorld development, in no
particular order.
...
CubeWorld keys are currently limited to a small subset, not allowing game developers
...
Using a gamepad also represents a known issue in CubeWorld, as some devices might not
...
doesn't do a very good job at selling CubeWorld or explaining what it is.
