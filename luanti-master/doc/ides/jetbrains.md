...
CLion try to determine a base configuration, but CubeWorld define it's own presets for easier setup. So you need to
...
CubeWorld dependencies in your vcpkg installation, you can do it right from CLion's Vcpkg tool window.
