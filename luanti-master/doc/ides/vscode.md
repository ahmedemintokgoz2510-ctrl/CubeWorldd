...
When you open the CubeWorld folder with VSCode, you should get a quick pick asking you for the default preset.
...
[Vcpkg](https://vcpkg.io) is the recommended way of installing CubeWorld dependencies.

Follow the official documentation to install it and install CubeWorld dependencies as explained in [Windows compilation process](../compiling/windows.md).
