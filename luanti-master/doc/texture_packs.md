CubeWorld Texture Pack Reference
===============================
...
* `name`: The texture pack name. Allows CubeWorld to determine the texture pack name even if
...
* `moon.png`: texture of the moon. Default texture is generated by CubeWorld
* `moon_tonemap.png`: tonemap to be used when `moon.png` was found
* `sun.png`: texture of the sun. Default texture is generated by CubeWorld
...
CubeWorld has three modes for rendering leaves nodes if the node has the
